...
n_SensorNumber = 6
list_Interval1 = [10, 20, 30, 50, 100, 150, 200, 250, 300]
n_Interval1 = 400
n_Interval2 = 800
...
for n_Interval1 in list_Interval1:
...
line_NDN = plt.plot(list_Interval1, list_Satisfication_NDN)
line_Consumer = plt.plot(list_Interval1, list_Satisfication_Consumer)
line_Producer = plt.plot(list_Interval1, list_Satisfication_Producer)
...
pp = PdfPages('SatisficationRatio-Interval.pdf')
...
line_NDN = plt.plot(list_Interval1, list_AverageDelay_NDN)
line_Consumer = plt.plot(list_Interval1, list_AverageDelay_Consumer)
line_Producer = plt.plot(list_Interval1, list_AverageDelay_Producer)
...
pp = PdfPages('AverageDelay-Interval.pdf')
plt.savefig(pp, format='pdf')
pp.close()
plt.close()
...
line_NDN = plt.plot(list_Interval1, list_Overhead_NDN)
line_Consumer = plt.plot(list_Interval1, list_Overhead_Consumer)
line_Producer = plt.plot(list_Interval1, list_Overhead_Producer)
...
pp = PdfPages('OverheadRatio-Interval.pdf')
plt.savefig(pp, format='pdf')
pp.close()
plt.close()
...
plt.axes().set_xticklabels(list_Interval1)

plt.title("Delay Distribution (NDN)")
plt.ylabel("Delay")
plt.xlabel("Request Interval")

pp = PdfPages('DelayNDN-Interval.pdf')
plt.savefig(pp, format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('DelayConsumer-Interval.pdf')
plt.savefig(pp, format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('DelayProducer-Interval.pdf')
plt.savefig(pp, format='pdf')
pp.close()
plt.close()
