...
PyObject *
_wrap_PyNs3MobilityModel_GetMobilityModel(PyNs3MobilityModel *PYBINDGEN_UNUSED(dummy), PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    ...
    node_ptr = (node ? node->obj : NULL);
    retval = ns3::MobilityModel::GetMobilityModel(ns3::Ptr< ns3::Object  > (node_ptr));
...
static PyMethodDef PyNs3MobilityModel_methods[] = {
    ...
    {(char *) "GetMobilityModel", (PyCFunction) _wrap_PyNs3MobilityModel_GetMobilityModel, METH_KEYWORDS|METH_VARARGS|METH_STATIC, NULL },
